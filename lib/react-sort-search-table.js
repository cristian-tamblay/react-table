	...
	SortableTblPager.prototype.render = function render() {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement('input', { type: 'button', style: { marginLeft: '5px' }, className: 'btn btn-primary', name: '', disabled: prevDisableStyle,
				...
				_react2.default.createElement('input', { type: 'button', style: { marginRight: '5px' }, className: 'btn btn-primary', name: '', disabled: nextDisableStyle,
					onClick: this.addPagge, value: 'Next' })
			),
			_react2.default.createElement(
				'div',
				{ className: 'desc col-xs-2' },
				_react2.default.createElement(
					'div',
					null,
					'P\xE1gina ',
			...
			_react2.default.createElement(
				...
				this.props.search && _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'col-xs-4' },
						_react2.default.createElement('input', { className: 'search', type: 'text', name: '', value: this.state.filter, placeholder: 'Filtrar Resultado', onChange: this.filter })
					),
					_react2.default.createElement(
						'div',
						{ className: 'col-xs-8' },
						_react2.default.createElement(_SortableTblPager.SortableTblPager, { curr: pagers.curr, totalPage: pagesCount, setCurrentPage: this.setCurrentPage,
