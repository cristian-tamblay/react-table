					...
					(
						<div className="search-box">
							<div className="col-xs-4">
								<input className="search" type="text" name="" value={this.state.filter} placeholder="Filtrar Resultado" onChange={this.filter} />
							</div>
							<div className="col-xs-8">
								<SortableTblPager curr={pagers.curr} totalPage={pagesCount} setCurrentPage={this.setCurrentPage}
